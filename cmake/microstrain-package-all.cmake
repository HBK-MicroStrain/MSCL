...
if(NOT DEFINED ENV{MICROSTRAIN_BUILD_DIR_DEBUG})
    ...
    get_filename_component(MICROSTRAIN_ROOT_BUILD_DIR "$ENV{MICROSTRAIN_BUILD_DIR_RELEASE}/.." ABSOLUTE)

    # Handle case-sensitive systems
    if(EXISTS "${MICROSTRAIN_ROOT_BUILD_DIR}/debug")
        set(ENV{MICROSTRAIN_BUILD_DIR_DEBUG} "${MICROSTRAIN_ROOT_BUILD_DIR}/debug")
    elseif(EXISTS "${MICROSTRAIN_ROOT_BUILD_DIR}/Debug")
        set(ENV{MICROSTRAIN_BUILD_DIR_DEBUG} "${MICROSTRAIN_ROOT_BUILD_DIR}/Debug")
    endif()
endif()
...
if(NOT DEFINED ENV{MICROSTRAIN_BUILD_DIR_RELEASE})
    ...
    get_filename_component(MICROSTRAIN_ROOT_BUILD_DIR "$ENV{MICROSTRAIN_BUILD_DIR_DEBUG}/.." ABSOLUTE)

    # Handle case-sensitive systems
    if(EXISTS "${MICROSTRAIN_ROOT_BUILD_DIR}/release")
        set(ENV{MICROSTRAIN_BUILD_DIR_RELEASE} "${MICROSTRAIN_ROOT_BUILD_DIR}/release")
    elseif(EXISTS "${MICROSTRAIN_ROOT_BUILD_DIR}/Release")
        set(ENV{MICROSTRAIN_BUILD_DIR_RELEASE} "${MICROSTRAIN_ROOT_BUILD_DIR}/Release")
    endif()
endif()
