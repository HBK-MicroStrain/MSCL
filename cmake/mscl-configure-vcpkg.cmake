...
elseif(UNIX AND NOT APPLE)
    ...
    # Note: this runs before the first project()/enable_language() call (see the include()
    #       order in the top-level CMakeLists.txt), so neither CMAKE_SYSTEM_PROCESSOR nor
    #       CMAKE_HOST_SYSTEM_PROCESSOR is populated yet. Ask the OS directly instead.
    execute_process(
        COMMAND uname -m
        OUTPUT_VARIABLE MSCL_HOST_PROCESSOR
        OUTPUT_STRIP_TRAILING_WHITESPACE
    )
    if(MSCL_HOST_PROCESSOR MATCHES "x86_64|AMD64")
        set(VCPKG_TARGET_TRIPLET "x64-linux-dynamic" CACHE STRING "Vcpkg target triplet")
    elseif(MSCL_HOST_PROCESSOR MATCHES "aarch64|arm64")
        set(VCPKG_TARGET_TRIPLET "arm64-linux-dynamic" CACHE STRING "Vcpkg target triplet")
    elseif(MSCL_HOST_PROCESSOR MATCHES "armv7|armv7l|armv7-a")
        message(FATAL_ERROR "Dynamic linking of dependencies is not supported by vcpkg on Linux ARM32")
    endif()
    unset(MSCL_HOST_PROCESSOR)
endif()
