...
namespace mscl
{
    ...
    const MipModel MipModel::mip_model_3dm_cx7_ar(MipModels::ModelNumber::model_3dm_cx7_ar);             // 3DM-CX7-AR
    const MipModel MipModel::mip_model_3dm_cx7_ahrs(MipModels::ModelNumber::model_3dm_cx7_ahrs);         // 3DM-CX7-AHRS
    const MipModel MipModel::mip_model_3dm_cx7_ins(MipModels::ModelNumber::model_3dm_cx7_ins);           // 3DM-CX7-INS
